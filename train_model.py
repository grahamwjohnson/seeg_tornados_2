...
def main(  
    ...
    **kwargs):
    ...
    if kwargs['val_every'] > 999 and trainer.valfinetune_dataset != None and trainer.valunseen_dataset != None:
...
class Trainer:
    ...
    def _update_barycenter(self, num_barycenter_iters, plot, plot_savedir, blur=0.05, n_iter=100, **kwargs):
        ...
        NOTE: make sure to implementing the DDP wrapper - to run
